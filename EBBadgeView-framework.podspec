Pod::Spec.new do |s|
  ...
  s.ios.preserve_paths       = 'EBBadgeView-framework/ios/EBBadgeView.framework'
  # s.ios.public_header_files  = 'ios/EBBadgeView.framework/Versions/A/Headers/*.h'
  s.ios.resource             = 'EBBadgeView-framework/ios/EBBadgeView.framework/Versions/A/Resources/**/*'
  s.ios.vendored_frameworks  = 'EBBadgeView-framework/ios/EBBadgeView.framework'
end
